...
public class RetailControllerExceptionHandler {

    @ExceptionHandler(value = {MethodArgumentNotValidException.class})
    @ResponseStatus(value = HttpStatus.UNPROCESSABLE_ENTITY)
    public ResponseEntity<VndErrors> RetailControllerValidationError(MethodArgumentNotValidException e, WebRequest request) {
